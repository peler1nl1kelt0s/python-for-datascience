...
class Baratheon(Character):
    ...
    """
    def __init__(self, name, is_alive = True, family_name = "Baratheon", eyes = "brown", hairs = "dark"):
        """
...
class Lannister(Character):
    ...
    """
    def __init__(self, name, is_alive = True, family_name = "Lannister", eyes = "blue", hairs = "light"):
        """
